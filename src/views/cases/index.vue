...
<script>
    import { getList, updateCase, destroyCase } from 'api/cases';
    ...
    export default{
        ...
        methods:{
            ...
            //编辑
            handleEdit(id) {
                this.$router.push({ path: '/case/' + id + '/edit' });
            },
            //删除
            handleDel(row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    destroyCase(row.id).then(response => {
                        this.$message({
                            message: '删除成功!',
                            type: 'success'
                        });
            ...
            handleModifyStatus(row, status) {
                updateCase(row.id, {is_draft: status}).then(response => {
                    this.$message({
                        message: '操作成功',
                        type: 'success'
                    });
